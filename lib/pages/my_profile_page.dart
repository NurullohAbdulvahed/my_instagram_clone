...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Users? users;
  String postImage = "https://firebasestorage.googleapis.com/v0/b/koreanguideway.appspot.com/o/develop%2Fpost2.png?alt=media&token=ac0c131a-4e9e-40c0-a75a-88e586b28b72";
  int? countPosts=0;
  List<Post> postList = [];
  File? _image;
  ...
  void _apiChangePhoto() {
    ...
    FileService.uploadImage(_image!, FileService.folderUserImg).then((value) => {
        ...
        children: [
          Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Row(
                children:[
                  users?.fullName == null ? const Text("Profile",style: TextStyle(color: Colors.black,fontFamily: "Billabong",fontSize: 30),) : Text(users!.fullName.toLowerCase(),style: TextStyle(color: Colors.black),),
                  const SizedBox(
                    width: 5,
                  ),
                  const Icon(
                        ...
                        child: Column(
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemCount: BottomSheetClass.bottomSheetList.length,
                              itemBuilder: (context,index){
                                return Container(
                                  ...
                                  child:index == 0 ? GestureDetector(
                                    ...
                                    child: Row(
                                      children: [
                                        BottomSheetClass.bottomSheetList[index].iconData!,
                                        const SizedBox(width: 10,),
                                        Text( BottomSheetClass.bottomSheetList[index].iconName!)
                                      ],
                                    ),
                                  ) : Row(
                                    children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              children: [
                                                Text(
                                                  users == null ? "0" : users!.followersCount.toString(),
                                                  style: const TextStyle(
                                                      color: Colors.black,
                                                      fontWeight: FontWeight.bold,
                                                      fontSize: 17),
                                            ...
                                            Column(
                                              children:[
                                                Text(
                                                  users == null ? "0" : users!.followingCount.toString(),
                                                  style: const TextStyle(
                                                      color: Colors.black,
                                                      fontWeight: FontWeight.bold,
                                                      fontSize: 17),
